...
class ThemeProvider with ChangeNotifier {
  ...
  //Global theme data we are always check if the light theme is enable
  ThemeData themeData() {
    return ThemeData(
      ...
      backgroundColor: isLightTheme ? Color(0xFFFFFFFF) : Color(0xFF26241e),
      scaffoldBackgroundColor:
          isLightTheme ? Color(0xFFFFFFFF) : Color(0xFF26241e),
    );
  }
...
// a class to manage specify colors and style in the app not support by the theme data
class ThemeColor {
  List<Color> gradient;
